...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        tempout1,cache1=affine_relu_forward(X,self.params['W1'],self.params['b1'])
        scores,cache2=affine_forward(tempout1,self.params['W2'],self.params['b2'])
        # scores=np.softmax(tempout2)
